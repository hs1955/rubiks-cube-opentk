...
namespace RubixCubeSolver.Objects
{
    class SidePlane : GameObject
    {
        ...
        public SidePlane(Shader shader, float scale = 1.0f, Vector3? position = null, Vector3? color = null, float[] angles = null, float[] invertRot = null, int[] swapAngles = null) : base(vertices, indices, shader, scale, position, color, angles, invertRot, swapAngles)
        {
