...
namespace RubixCubeSolver.Objects
{
    class Plane : GameObject
    {
        ...
        public Plane(Shader shader, float scale = 1.0f, float horizontalAngle = 0.0f, float verticalAngle = 0.0f, Vector3? position = null, Vector3? color = null, bool switchYForZ = false, bool switchXForZ = false) : base(vertices, indices, shader, scale, horizontalAngle, verticalAngle, position, color, switchYForZ, switchXForZ)
        {
